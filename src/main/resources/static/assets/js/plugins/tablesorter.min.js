!function($) {
    $.extend({
        tablesorter: new function() {
            ...
            function appendToTable(e, t) {
                ...
                for (var n = t, o = n.row, a = n.normalized, i = a.length, s = a[0].length - 1, d = $(e.tBodies[0]), c = [], u = 0; i > u; u++) {
                    ...
                    if (c.push(o[l]), !e.config.appender)
                        for (var f = o[l].length, h = 0; f > h; h++)
            ...
            function computeTableHeaderCellIndexes(e) {
                for (var t = [], r = {}, n = e.getElementsByTagName("THEAD")[0], o = n.getElementsByTagName("TR"), a = 0; a < o.length; a++)
                    for (var i = o[a].cells, s = 0; s < i.length; s++) {
                        var d, c = i[s], u = c.parentNode.rowIndex, l = u + "-" + c.cellIndex, f = c.rowSpan || 1, h = c.colSpan || 1;
            ...
            function applyWidget(e) {
                for (var t = e.config.widgets, r = t.length, n = 0; r > n; n++)
            ...
            function multisort(table, sortList, cache) {
                ...
                for (var dynamicExp = "var sortWrapper = function(a,b) {", l = sortList.length, i = 0; l > i; i++) {
                    var c = sortList[i][0], order = sortList[i][1], s = "text" == table.config.parsers[c].type ? 0 == order ? makeSortFunction("text", "asc", c): makeSortFunction("text", "desc", c): 0 == order ? makeSortFunction("numeric", "asc", c): makeSortFunction("numeric", "desc", c), e = "e" + i;
            ...
            this.defaults = {
                    ...
                    if (this.tHead && this.tBodies) {
                        ...
                        fixColumnWidth(this), r.click(function(e) {
                            ...
                            if (!this.sortDisabled && i > 0) {
                                ...
                                if (this.order = this.count++%2, this.lockedOrder && (this.order = this.lockedOrder), e[o.sortMultiSortKey])if (isValueInArray(s, o.sortList))
                                    for (var d = 0; d < o.sortList.length; d++) {
                                        var c = o.sortList[d], u = o.headerList[c[0]];
                            ...
                            var r = this.config, o = [t.parentNode.rowIndex - 1, t.cellIndex];
                ...
                for (var t = parsers.length, r=!0, n = 0; t > n; n++)
    ...
    ts.addParser({
        ...
        format: function(e, t, r) {
            var n = t.config, o = n.parserMetadataName ? n.parserMetadataName: "sortValue";
            return $(r).metadata()[o]
        },
        type: "numeric"
    }), ts.addWidget({
